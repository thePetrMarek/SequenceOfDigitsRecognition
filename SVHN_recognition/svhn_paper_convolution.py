...
class SVHNPaperConvolution:
    def get_name(self):
        return "SVHN_paper_no_recurrence"
    ...
    def inference(self, input, keep_prob, is_training):
        with tf.name_scope("inference"):
            ...
            with tf.variable_scope("Linear_output"):
                label_one = self._fully_connected(reshaped, 1536, 11, name="label_one")
                label_two = self._fully_connected(reshaped, 1536, 11, name="label_two")
                label_three = self._fully_connected(reshaped, 1536, 11, name="label_three")
                label_four = self._fully_connected(reshaped, 1536, 11, name="label_four")
                label_five = self._fully_connected(reshaped, 1536, 11, name="label_five")
                label_six = self._fully_connected(reshaped, 1536, 11, name="label_six")
            ...
            predicted_positions = self._fully_connected(reshaped, 1536, 4)
