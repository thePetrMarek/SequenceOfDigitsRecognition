...
class SequenceReshapedConvolutionBatchnormStride:
    def get_name(self):
        return "sequence_reshaped_convolution_batchnorm_stride"
    ...
    def inference(self, input, keep_prob, is_training):
        with tf.name_scope("inference"):
            ...
            max_pool1 = self._max_pooling(dropout1, [1, 5, 5, 1], [1, 4, 4, 1])
            ...
            max_pool2 = self._max_pooling(dropout2, [1, 4, 4, 1], [1, 3, 3, 1])
            ...
            max_pool3 = self._max_pooling(dropout3, [1, 2, 2, 1], [1, 1, 1, 1])

            reshaped = tf.reshape(max_pool3, [-1, 1152])
